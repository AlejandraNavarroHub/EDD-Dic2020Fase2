from storage import main as j
import time
inicio = time.time()

#Area para probar funciones
print("------------------Pruebas para Bases de datos-----------------------")
print("CREAR BD:", j.createDatabase("CALIFICAION","bplus","utf8"), "Esperado:",0)
print("CREAR BD:", j.createDatabase("CALIFICAION","hash","utf8"), "Esperado:",2)
